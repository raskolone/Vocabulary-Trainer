...
const translations = {
  en: {
    ...
    'about.desc': 'CRIBRO ENGLISH is a modern platform for learning English. It provides vocabulary tailored to your level, interactive exercises, and an intelligent spaced repetition system.',
  ...
  pl: {
    ...
    'about.desc': 'CRIBRO ENGLISH to nowoczesne narzędzie do nauki języka angielskiego. Oferuje słownictwo dopasowane do Twojego poziomu, interaktywne ćwiczenia i inteligentny system powtórek.',
...
export const LanguageProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    const savedLang = (function(){ try { return localStorage.getItem('app_language'); } catch(e) { return null; } })() as Language;
